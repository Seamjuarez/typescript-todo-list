...
const taskInput = document.getElementById("taskInput") as HTMLInputElement; // Campo de entrada de tareas
const addTaskBtn = document.getElementById("addTask") as HTMLButtonElement; // Botón para añadir tareas
const todoBody = document.getElementById("todoBody") as HTMLTableSectionElement; // Cuerpo de la tabla de tareas
const showCompleteCheckbox = document.getElementById("showComplete") as HTMLInputElement; // Checkbox para mostrar completadas
const removeCompleteBtn = document.getElementById("removeComplete") as HTMLButtonElement; // Botón para eliminar completadas
const summaryDiv = document.getElementById("summary") as HTMLDivElement; // Resumen de tareas
...
function renderTodoList(): void {
    ...
    const includeComplete: boolean = showCompleteCheckbox.checked;
    const items: TodoItem[] = collection.getTodoItems(includeComplete);
    ...
    items.forEach((item: TodoItem) => {
        ...
        // Columna Tarea
        const taskCell: HTMLTableCellElement = document.createElement('td');
